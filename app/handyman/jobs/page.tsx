/**
 * Handyman — All Jobs list · Server Component.
 *
 ...
 *
 * Jobs are sorted: In Progress → Pending → Completed, then newest-first within
 * each group. The current page slice is re-grouped by status for display.
 */
...
export default async function AllJobsPage({
  ...
  const groups = (["In Progress", "Pending", "Completed"] as const).map((status) => ({
    status,
